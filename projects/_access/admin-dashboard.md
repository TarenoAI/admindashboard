...
2. Falls Dashboard nicht erreichbar: Grund nennen (Auth/Port/Server) + Fallback aus API/Dateien liefern.
3. Keine "keine Informationen"-Antwort ohne vorigen Dashboard-Check.
